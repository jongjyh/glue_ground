...
class NASTrainer(Trainer):
    ...
    def train(
        ...
        **kwargs,
        ...
        arch_loss = torch.tensor(0.0).to(args.device)
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (
                    ...
                    with model.no_sync():
                        tr_loss_step = self.training_step(model, inputs[0])
                # firstly update weight
                else:
                    tr_loss_step = self.training_step(model, inputs[0])
